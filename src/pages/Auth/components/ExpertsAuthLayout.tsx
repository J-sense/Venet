    ...
    <div className="w-full bg-[#080A0E] flex flex-col relative h-screen overflow-hidden">
      ...
      <main className="flex w-full flex-1 h-full">
        ...
        <div className="flex-1 flex items-start justify-center w-full z-30 px-4 py-4 sm:px-6 lg:py-12 overflow-y-auto relative h-full pt-20 md:pt-24 lg:pt-14">
          ...
          {/* Form Container */}
          <div className="w-full max-w-[400px] md:max-w-[420px] lg:max-w-[480px] xl:max-w-[520px] relative z-10 mt-12 md:mt-16 lg:mt-10">
            <div className="relative rounded-3xl sm:rounded-[2rem] overflow-hidden border border-white/[0.06] shadow-[0_16px_60px_-15px_rgba(0,0,0,0.8)] backdrop-blur-3xl">
              ...
              <div className="relative z-10 p-6 sm:p-7 lg:px-10 lg:py-8">
