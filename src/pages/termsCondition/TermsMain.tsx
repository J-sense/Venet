      ...
      <main className="max-w-4xl mx-auto px-6 py-16 text-[#E2E8F0] space-y-12">
        ...
        <div className="bg-[#0F172A] rounded-xl p-6 shadow-lg shadow-black/20">
          <p className="text-lg leading-relaxed text-[#94A3B8]">
            ...
            vNET platform. By accessing or using our services, you agree to be
        ...
        <section className="space-y-4">
          ...
          <p className="text-[#94A3B8]">
            By creating an account, accessing, or using vNET's services, you
            agree to comply with and be bound by these Terms and Conditions, our
            Privacy Policy, and our Disclaimer. If you do not agree to these
        ...
        <section className="space-y-4">
          ...
          <p className="text-[#94A3B8]">
            ...
            violate these Terms or engage in conduct that we deem inappropriate
            or harmful to our platform or other users.
          </p>
        </section>
        ...
        <section className="space-y-4">
          ...
          <p className="text-[#94A3B8] mt-2">
            All subscriptions are billed monthly on a recurring basis.
          </p>
          ...
          <ul className="list-disc pl-6 space-y-2 text-[#94A3B8]">
            ...
            <li>
              You authorize us to charge your payment method automatically each
              billing cycle.
            </li>
            <li>
          ...
          <p className="text-[#94A3B8]">
            ...
            fees, in whole or in part. However, if you cancel, your account will
        ...
        <section className="space-y-4">
          ...
          <p className="text-[#94A3B8]">
            All content on the vNET platform, including text, graphics, logos,
            images, software, and AI-generated roadmaps, is the property of vNET
        ...
        <section className="space-y-4">
          ...
          <p className="text-[#94A3B8]">
            When you book a session with an expert Coach or Consultant through
            our platform, you acknowledge that the expert is an independent
            professional. vNET facilitates the connection but is not responsible
            for the quality, accuracy, or outcomes of expert services. Any
            disputes with experts should be resolved directly with the expert.
          </p>
        </section>
        ...
        <section className="space-y-4">
          ...
          <p className="text-[#94A3B8] uppercase">
            TO THE MAXIMUM EXTENT PERMITTED BY LAW, vNET SHALL NOT BE LIABLE FOR
        ...
        <section className="space-y-4">
          ...
          <p className="text-[#94A3B8]">
            You agree to indemnify and hold harmless vNET, its affiliates, and
            ...
            fees) arising from your use of the platform or violation of these
            Terms.
          </p>
        </section>
        ...
        <section className="space-y-4">
          ...
          <p className="text-[#94A3B8]">
            ...
            of the platform shall be resolved in the courts located in San
