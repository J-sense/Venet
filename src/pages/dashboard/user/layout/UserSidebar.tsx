...
export function UserSidebar({ isOpen, onClose, navItems, user: userProp }: SidebarProps) {
  ...
  const user = userProp || myProfile?.data || userFromRedux;
  ...
  return (
    <>
      ...
      >
        ...
        {/* Bottom Actions - Displays User Name */}
          ...
          <div className="flex items-center justify-between gap-3 bg-white/[0.02] border border-white/[0.05] rounded-2xl p-3 shadow-md select-none">
            ...
            <div className="flex items-center gap-2.5 min-w-0 flex-1">
              ...
              <div className="min-w-0 flex-1">
                ...
                {user?.email && (
                  <p className="text-[11px] text-zinc-500 font-medium truncate mt-0.5 leading-none">
                    {user.email}
                  </p>
                )}
              </div>
