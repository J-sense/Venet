...
import { Award, BookOpen, Calendar, CheckCircle2, ChevronRight, Sparkles, TrendingUp } from "lucide-react";
      ...
      <div className="max-w-7xl mx-auto relative z-10 space-y-8">
        ...
        <section>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <StatCard title="Active Programs" value="2" icon={<TrendingUp className="text-blue-400" />} />
            <StatCard title="Tasks Completed" value="0" icon={<CheckCircle2 className="text-green-400" />} />
            <StatCard title="Certificates" value="0" icon={<Award className="text-purple-400" />} />
          </div>
        </section>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <div className="lg:col-span-8 space-y-8">
            {/* My Programs */}
            <section>
              <Card className="bg-[#0D1526] border border-white/5 rounded-3xl p-8 relative overflow-hidden shadow-2xl shadow-black/40 group">
                ...
                <div className="flex items-center justify-between mb-8 relative z-10">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-zinc-400 mt-0.5 font-medium">Continue where you left off</p>
                    </div>
                  </div>
                ...
                <div className="space-y-4 relative z-10">
                  {!myPrograms || myPrograms.length === 0 ? (
                    <div className="flex flex-col items-center justify-center py-16 px-4 border border-dashed border-white/10 rounded-2xl bg-gradient-to-b from-white/[0.02] to-transparent">
                      ...
                      <h3 className="text-lg font-semibold text-white mb-2">No active programs</h3>
                      <p className="text-sm text-zinc-400 text-center max-w-sm mb-6 leading-relaxed">
                        You haven't enrolled in any programs yet. Explore our catalog to find the perfect fit for your goals.
                      </p>
                ...
                <div className="flex items-center justify-between mb-8 relative z-10">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-zinc-400 mt-0.5 font-medium">Your schedule for this week</p>
                    </div>
                  </div>
                  <button className="text-purple-400 hover:text-purple-300 text-sm font-semibold transition-colors flex items-center gap-1 group/btn">
                    View Calendar <ChevronRight className="w-4 h-4 transition-transform group-hover/btn:translate-x-1" />
                  </button>
                </div>

                <div className="space-y-3 relative z-10">
                  {upcomingTasks.map((task, index) => (
                    <div key={index} className="transition-transform duration-300 hover:translate-x-1">
                      <TaskItem
                        title={task.title}
          ...
          <div className="lg:col-span-4 space-y-8">
            ...
            <section className="space-y-4">
              <div className="flex justify-between items-center mb-2">
                <h3 className="font-bold text-white text-lg tracking-tight">Recommended Experts</h3>
