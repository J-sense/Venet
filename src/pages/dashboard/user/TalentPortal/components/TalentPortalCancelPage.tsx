...
import { X, LayoutDashboard, RotateCcw } from "lucide-react";

export const TalentPortalCancelPage = () => {
  return (
    <div className="min-h-screen text-white py-24 relative overflow-hidden flex items-center justify-center bg-[radial-gradient(circle_at_top,_rgba(239,68,68,0.12),_transparent_35%),radial-gradient(circle_at_bottom_right,_rgba(255,255,255,0.04),_transparent_20%),linear-gradient(180deg,#020205_0%,#08090D_40%,#05060A_100%)]">
      <div className="absolute inset-0 pointer-events-none opacity-80">
        <div className="absolute left-1/2 top-16 w-[520px] h-[520px] -translate-x-1/2 rounded-full blur-[110px] bg-red-500/10" />
      ...
      <div className="w-full max-w-xl bg-[#11131a] border border-white/10 shadow-[0_24px_80px_rgba(0,0,0,0.35)] rounded-[28px] p-8 md:p-12 text-center relative z-10 mx-6">
        <div className="w-20 h-20 rounded-full bg-rose-500/10 border border-rose-500/25 flex items-center justify-center mx-auto mb-6">
          <X className="w-10 h-10 text-rose-400 stroke-[2.5]" />
        </div>

        <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-rose-500/10 border border-rose-500/20 text-rose-300 text-sm font-medium mb-4">
        ...
        <p className="text-[#c7c7d1] text-base md:text-lg mb-10 leading-relaxed max-w-2xl mx-auto">
          You canceled the checkout process for the Talent Portal subscription. No payment was charged. You can unlock the portal at any time whenever you're ready.
        </p>
...
export default TalentPortalCancelPage;
